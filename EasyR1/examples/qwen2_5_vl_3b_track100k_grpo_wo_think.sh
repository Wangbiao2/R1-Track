...
python3.10 -m verl.trainer.main \
    ...
    data.train_files=./data/track100k@train \
    data.val_files=./data/track100k@test \
    data.max_prompt_length=1024 \
    data.max_response_length=64 \
    data.max_pixels=313600 \
    data.min_pixels=10000 \
    data.rollout_batch_size=768 \
    ...
    worker.rollout.n=6 \
    trainer.experiment_name=qwen2_5_vl_3b_track100k_grpo_not_think \
