...
from ...utils.reward_score import math_compute_score, r1v_compute_score, track_compute_score, track_compute_score_not_think
...
class CustomRewardManager:
    def __init__(self, tokenizer: PreTrainedTokenizer, compute_score: str):
        ...
        elif compute_score == "track":
            self.compute_score: Callable[[str, str], RewardScore] = track_compute_score
        elif compute_score == "track_not_think":
            self.compute_score: Callable[[str, str], RewardScore] = track_compute_score_not_think
        else:
    ...
    def __call__(self, data: DataProto) -> Tuple[torch.Tensor, Dict[str, Any]]:
        ...
        for i in range(len(data)):
            ...
            score = self.compute_score(response_str, ground_truth, valid_response_length.item())
